...
class SwaggerController extends Controller {
    ...
    public function ui($environment = null) {
        ...
        $base = Config::get('swagger.doc-ui-access', 'spec');
        $docs = Config::get('swagger.docs-http-route', 'spec');

        $defData = ["api_docs" => "/$base/$docs/" . strtolower($env['name'])];
        $viewRenderer = @$env['custom-viewer'] ?? @Config::get('swagger')["custom-view"] ?? 'package-swagger::main';
